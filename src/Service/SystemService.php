...
use App\System\SystemInformationRecord;
...
class SystemService
{
    ...
    public function getSystemInformation()
    {
        ...
        // TODO $aData[] = new SystemInformationRecord('Doctrine DBAL', DBALVersion::VERSION, 'Libraries');
        ...
        $queryCache = get_class($this->entityManager->getConfiguration()->getQueryCache());
        $metadataCache = get_class($this->entityManager->getConfiguration()->getMetadataCache());
