...
class PartParameter extends BaseEntity
{
    ...
    /**
     * @ORM\ManyToOne(targetEntity="App\Entity\Part", inversedBy="parameters")
     ...
     *
     * @ORM\ManyToOne(targetEntity="App\Entity\SiPrefix")
     * @Groups({"default"})
     *
     * @var SiPrefix
     */
     ...
     * Returns the unit.
     *
     * @return App\Entity\Unit the unit
     */
     ...
     * Sets the unit.
     *
     * @param App\Entity\Unit $unit The unit to set
     */
     ...
     * Returns the part.
     *
     * @return App\Entity\Part the part
     */
     ...
     *
     * @return App\Entity\SiPrefix the si prefix or null
     */
     ...
     *
     * @param App\Entity\SiPrefix $prefix The prefix to set, or null
     */
