 ...
 * @ExtModelName("PartKeepr.ProjectBundle.Entity.ReportPart")
 */
class ReportPart extends BaseEntity
{
    /**
     * @ORM\ManyToOne(targetEntity="App\Entity\Report",inversedBy="reportParts")
     * @Groups({"default"})
     *
     * @var Report
     */
    ...
    /**
     * @VirtualOneToMany(target="App\Entity\Part")
     * @Groups({"default"})
     *
     * @var Part[]
     */
    ...
    /**
     * @VirtualOneToMany(target="App\Entity\ProjectPart")
     * @Groups({"default"})
     *
     * @var ProjectPart[]
     */
