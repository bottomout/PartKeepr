 ...
 * @ExtModelName("PartKeepr.FootprintBundle.Entity.Footprint")
 */
class Footprint extends BaseEntity
{
     ...
     * Adds an IC Logo.
     *
     * @param FootprintAttachment|App\Entity\TempUploadedFile $attachment Either a FootprintAttachment or a TempUploadedFile
     *
     * @return void
     */
