...
use App\Annotation\UploadedFileCollection;
use App\Exception\CategoryNotAssignedException;
use App\Exception\MinStockLevelOutOfRangeException;
use App\Exception\StorageLocationNotAssignedException;
...
class Part extends BaseEntity
{
     ...
     *
     * @ORM\ManyToOne(targetEntity="App\Entity\PartCategory")
     * @Assert\NotNull()
     * @Groups({"default"})
     *
     * @var PartCategory
     ...
     *
     * @ORM\ManyToOne(targetEntity="App\Entity\Footprint")
     * @Groups({"default"})
     *
     * @var Footprint
     */
     ...
     *
     * @ORM\OneToMany(targetEntity="App\Entity\PartManufacturer",mappedBy="part",cascade={"persist", "remove"},
     *                                                                                                                orphanRemoval=true)
     * @Groups({"default"})
     *
     * @var ArrayCollection
     ...
     *
     * @ORM\OneToMany(targetEntity="App\Entity\PartDistributor",mappedBy="part",cascade={"persist", "remove"},
     *                                                                                                               orphanRemoval=true)
     * @Groups({"default"})
     *
     * @var ArrayCollection
     ...
     *
     * @ORM\OneToMany(targetEntity="App\Entity\PartAttachment",
     ...
     *
     * @ORM\OneToMany(targetEntity="App\Entity\StockEntry",mappedBy="part",cascade={"persist", "remove"})
     * @Groups({"stock"})
     *
     * @var ArrayCollection
     */
     ...
     *
     * @ORM\OneToMany(targetEntity="App\Entity\PartParameter",
     *                mappedBy="part",cascade={"persist", "remove"}, orphanRemoval=true)
     * @Groups({"default"})
     *
     * @var ArrayCollection
     ...
     *
     * @ORM\OneToMany(targetEntity="App\Entity\MetaPartParameterCriteria",
     *                mappedBy="part",cascade={"persist", "remove"}, orphanRemoval=true)
     * @Groups({"default"})
     *
     * @var ArrayCollection
    ...
    /**
     * @ORM\OneToMany(targetEntity="App\Entity\ProjectPart", mappedBy="part")
     *
     * @var ArrayCollection
     **/
     ...
     *
     * @throws App\Exceptions\StorageLocationNotAssignedException
     */
     ...
     *
     * @return App\Entity\StorageLocation $storageLocation The storage location
     */
     ...
     *
     * @param App\Entity\StorageLocation $storageLocation The storage location
     */
