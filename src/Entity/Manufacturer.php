 ...
 * @ExtModelName("PartKeepr.ManufacturerBundle.Entity.Manufacturer")
 **/
class Manufacturer extends BaseEntity
{
     ...
     *
     * @ORM\OneToMany(targetEntity="App\Entity\ManufacturerICLogo",mappedBy="manufacturer",cascade={"persist", "remove"}, orphanRemoval=true)
     *
